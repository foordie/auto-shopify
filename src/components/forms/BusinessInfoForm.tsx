...
export default function BusinessInfoForm({ onSubmit, isLoading = false }: BusinessInfoFormProps) {
  const { register, handleSubmit, formState: { errors }, reset } = useForm<BusinessInfoFormData>({
